        ...
        <div className="max-w-md">
          ...
          <ul className="mt-8 space-y-4">
            <li className="flex items-center gap-3 text-background/80">
              ...
              <span>Habits, sleep, learning, goals - all in one place</span>
            </li>
            <li className="flex items-center gap-3 text-background/80">
              <Check className="h-5 w-5 shrink-0 text-green-400" />
            ...
            <li className="flex items-center gap-3 text-background/80">
              <Check className="h-5 w-5 shrink-0 text-green-400" />
              <span>Free forever - no premium walls</span>
            </li>
            <li className="flex items-center gap-3 text-background/80">
              <Check className="h-5 w-5 shrink-0 text-green-400" />
              <span>Open source and built in public</span>
            </li>
          </ul>
        </div>

        <p className="text-sm text-background/50">
          Built by Asym Alwali - 19, Nigeria, CS Student
        </p>
      </div>
